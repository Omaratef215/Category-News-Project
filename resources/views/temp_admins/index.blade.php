<x-layout>
    <x-slot:nav>
        ...
        <a href="{{ route('temp_frontend.categoryList') }}" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" style="margin-left: 650px" aria-current="page">
            Site
        </a>
    ...
    @section('title', 'temp_admins')

    @section('content')
        <div class="container">
            <a href="{{ route('temp_admins.create') }}" class="rounded-md bg-blue-500 px-4 py-2 text-white mb-3 inline-block">Create New Admin</a>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <div class="flex justify-center space-x-2">
                                <form action="{{ route('temp_admins.destroy', $admin->id) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
